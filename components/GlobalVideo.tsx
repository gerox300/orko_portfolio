...
export function GlobalVideo() {
    ...
    return (
        ...
        >
            {/* suppressHydrationWarning evita el mismatch de className entre SSR y cliente */}
            <video
            ...
            <div ref={brumaRef} style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
                <div style={{
                    ...
                    mixBlendMode: 'screen', filter: 'blur(40px)', pointerEvents: 'none',
                }} />
                <div style={{
                    position: 'absolute', inset: 0,
                    backgroundImage: 'url("/texture_green.png")', backgroundSize: 'cover',
